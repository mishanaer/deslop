...
import { IconArrowBackIosNew as ArrowBackIosNewIcon } from "@deslop/primitives/material-symbols-react"
...
import * as appBarStyles from "../AppBar/AppBar.module.css"
...
const layers = [
    {
        ...
        tokens: ["--ui-component-header-action-radius"],
...
const buttonShape = {
    ...
    width: 44,
    height: 44,
    borderRadius: "var(--ui-component-header-action-radius)",
}
...
const BackButtonLayersShowcase = () => {
...
export default BackButtonLayersShowcase
