...
TypeScript только для Primitives и Web UI.
...
- Сначала определить продуктовую границу: должны ли desktop controls входить в
  Mini App или жить в отдельном пакете. Автоматический перенос Web UI в Mini App
...
Внутренний экран Memento не импортирует `@deslop/web-ui`, все новые controls
...
- Зафиксированы React 19-only API в React 18 package build и нехватка desktop
  controls, из-за которой внутренняя страница Memento оставалась на Web UI.
