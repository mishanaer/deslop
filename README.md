...
[sound](https://github.com/mishanaer/sound) — скилл для процедурных
интерфейсных звуков. Каждое воспроизведение немного отличается благодаря
процедурному шуму, поэтому звук ощущается менее механическим.
