...
продуктов Deslop. Репозиторий Deslop остаётся источником истины, а продукты
подключают версионированную сборку пакета.
...
Web UI и Mini App используют те же публичные пути пакета. Для отдельной иконки
импортируйте SVG из `@deslop/primitives/icons/*`.
