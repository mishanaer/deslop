...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group relative flex h-12 w-full min-w-0 items-center rounded-text-field border border-input bg-input transition-[color,box-shadow] outline-none has-[>textarea]:h-auto",
